...
const features = [
    { name: 'Origen', description: 'Diseñado por Good Goods, Inc.' },
    { name: 'Material', description: 'Base de nogal sólido con imanes de tierras raras y cubierta de acero con recubrimiento en polvo' },
    { name: 'Dimensiones', description: '6.25" x 3.55" x 1.15"' },
    { name: 'Acabado', description: 'Lijado a mano y acabado con aceite natural' },
    { name: 'Incluye', description: 'Bandeja de tarjetas de madera y 3 paquetes de recambio' },
    { name: 'Consideraciones', description: 'Hecho con materiales naturales. El grano y el color varían con cada artículo.' },
]

function CortinaMelbourne() {
        ...
        <>
            ...
            <div className="bg-white">
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    ...
                    La cortina Melbourne es una exquisita adición a cualquier espacio, ofreciendo una fusión perfecta 
                    de elegancia y funcionalidad. Confeccionada con materiales de alta calidad y un diseño 
                    meticuloso, esta cortina no solo proporciona privacidad y control de la luz, sino que también 
                    añade un toque de sofisticación a cualquier habitación. Su estilo moderno y versátil la convierte 
                    en una opción ideal para aquellos que buscan mejorar la estética y el ambiente de su hogar u oficina.
                    </p>
                    ...
                    <div className="flex justify-center items-center h-full">
                        <img
                            src="https://images.unsplash.com/photo-1577926606472-fc6d3a33f7e1?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Cortina de Melbourne"
...
export default CortinaMelbourne
