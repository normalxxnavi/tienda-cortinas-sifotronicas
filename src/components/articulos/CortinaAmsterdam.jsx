...
const features = [
    { name: 'Origen', description: 'Diseñado por Dutch Designs Inc.' },
    { name: 'Material', description: 'Tela de lino resistente con estampado de tulipanes holandeses' },
    { name: 'Dimensiones', description: '6.5" x 4" x 1.2"' },
    { name: 'Acabado', description: 'Bordeado con encaje tradicional holandés' },
    { name: 'Incluye', description: 'Soportes de montaje y instrucciones de instalación' },
    { name: 'Consideraciones', description: 'Inspira un ambiente acogedor con un toque europeo.' },
]

function CortinaAmsterdam() {
        ...
        <>
            ...
            <div className="bg-white">
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    ...
                    Las Cortinas Amsterdam de los Países Bajos son una verdadera obra de arte para embellecer 
                    cualquier espacio. Inspiradas en la rica herencia cultural y artística de los Países Bajos, estas 
                    cortinas están confeccionadas con tejidos de lino de primera calidad y adornadas con intrincados 
                    detalles florales. Su diseño elegante y refinado añade un toque de encanto europeo a cualquier 
                    habitación, mientras que su calidad artesanal garantiza durabilidad y estilo duradero. Perfectas 
                    para aquellos que desean crear un ambiente acogedor y sofisticado en su hogar u oficina, las 
                    Cortinas Amsterdam de los Países Bajos son una elección excepcional para quienes aprecian 
                    la belleza y la artesanía en cada detalle.
                    </p>
                    ...
                    <div className="flex justify-center items-center h-full">
                        <img
                            src="https://images.unsplash.com/photo-1614270695397-bdc1e7027961?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Cortina Amsterdam de los Paises Bajos"
...
export default CortinaAmsterdam