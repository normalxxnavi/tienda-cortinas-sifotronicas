...
const features = [
    { name: 'Origen', description: 'Diseñado por Demencial Design Studio' },
    { name: 'Material', description: 'Seda sintética de alta calidad con bordados de lujo' },
    { name: 'Dimensiones', description: '7.2" x 4.5" x 1.2"' },
    { name: 'Acabado', description: 'Detalles dorados y ribetes de encaje' },
    { name: 'Incluye', description: 'Varillas de cortina y accesorios de montaje' },
    { name: 'Consideraciones', description: 'Perfecto para añadir un toque de elegancia a cualquier habitación.' },
]

function CortinaDemencial() {
        ...
        <>
            ...
            <div className="bg-white">
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    ...
                    Las Cortinas Demencial de Lujo Naranjas son la expresión máxima de elegancia y lujo en la 
                    decoración del hogar. Confeccionadas con seda sintética de alta calidad y adornadas con 
                    bordados de lujo, estas cortinas ofrecen un estilo opulento y sofisticado. Su vibrante color naranja 
                    claro añade un toque de calidez y vitalidad a cualquier espacio, mientras que los detalles dorados 
                    y los ribetes de encaje completan su aspecto lujoso. Perfectas para aquellos que buscan crear un 
                    ambiente de gran lujo en su hogar u oficina, las Cortinas Demencial de Lujo Naranjas son una 
                    elección excepcional para quienes aprecian la belleza y la calidad en cada detalle.
                    </p>
                    ...
                    <div className="flex justify-center items-center h-full">
                        <img
                            src="https://images.unsplash.com/photo-1540905255418-61f7468593cc?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
export default CortinaDemencial